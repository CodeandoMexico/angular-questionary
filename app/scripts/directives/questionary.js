...
app.run(['$templateCache', function($templateCache){
  ...
  $templateCache.put('questionary.html', '<form novalidate><div class="questionary-container"><div ng-transclude></div><div class="navigation-container"><button class="navigation-control previous pull-left btn btn-default" ng-if="navigation.hasPrevious" ng-click="moveToPreviousSection()"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;regresar</button><button class="navigation-control next pull-right btn btn-default" ng-click="moveToNextSection()">continuar&nbsp;<span class="glyphicon glyphicon-arrow-right"></span></button></div></div></form>')
  ...
  $templateCache.put('question.html', '<ng-form name="questionForm"><div class="question-container"><div class="question-header"><p>{{ questionForm.$valid }}</p><p class="question-title">{{ title }}</p><p class="question-description text-muted">{{ description }}</p><div ng-include="\'errors.html\'"></div></div><div class="question-body" ng-include="template[type]"></div><div ng-transclude></div><pre ng-if="debug">{{ codeData | json}}</pre></div></ng-form>');
  ...
  $templateCache.put('radio-input.html','<div class="radio" ng-repeat="opt in body.options"><label><input type="radio" name="radio{{idx}}" value="{{opt.value}}" ng-model="body.selected_value">{{opt.label}}</label></div>');
