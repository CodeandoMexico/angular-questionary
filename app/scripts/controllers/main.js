      ...
      },
      {
        ...
        questions : [
          ...
          },
          {
            ...
            type     : 'radio',
            body     : {
              value    : 'Es nuevo y distinto a lo que existe y/o el proceso de elaboración/comercialización es innovador',
          ...
          },
          {
            ...
            type     : 'radio',
            body     : {
              value    : 'Aceptar el empleo y dejar de trabajar en mi empresa',
      ...
      },
      {
        ...
        questions : [
          ...
          },
          {
            ...
            type     : 'radio',
            body     : {
              value    : 'Llevo personalmente todas las cuentas de mi negocio sin apuntar nada',
          ...
          },
          {
            ...
            type     : 'radio',
            body     : {
              value    : 'Todas las decisiones del día a día las toma el dueño(s) de la empresa',
          ...
          },
          {
            ...
            type     : 'radio',
            body     : {
              value    : 'Ninguna, no se necesita / no tengo recursos',
          ...
          },
          {
            ...
            type     : 'radio',
            body     : {
              value    : 'No, lo solicité pero me rechazaron / No lo he solicitado porque creo que no me lo darían',
        ...
        questions : [
          {
            ...
            type   : 'radio',
            body     : {
              value    : 'Mi empresa es pequeña, las ganancias que obtengo me alcanzan apenas para los gastos básicos, si tuviera la oportunidad buscaría recursos de otra manera',
              options  : [
          ...
          },
          {
            ...
            type   : 'radio',
            body     : {
              value    : 'Mi proyecto se encuentra en una etapa inicial o de formación / tiene una estructura administrativa pequeña en donde yo tomo todas las decisiones del día a día',
              options  : [
      ...
      },
      {
        ...
        questions : [
          ...
          },
          {
            ...
            type     : 'radio',
            body     : {
              value    : 'NO tengo empleo y NO tengo otro negocio',
              options  : [
          ...
          },
          {
            ...
            type     : 'radio',
            body     : {
              value    : 'Ninguna, no se necesitará / no tengo recursos para eso',
        ...
        questions : [
          {
            ...
            type   : 'radio',
            body   : {
              value : 'El principal motivo para iniciar mi empresa es tener recursos para cubrir los gastos básicos. Si tuviera la oportunidad buscaría recursos de otra manera.',
              options: [
