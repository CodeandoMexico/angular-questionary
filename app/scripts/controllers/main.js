    ...
    $scope.questionary = [
      ...
      },
      {
        ...
        questions : [
          ...
          {
            title  : 'Del total de personas que trabajan en la empresa, ¿cuantas son familiares de los dueños  (incluye: padres, hijos, abuelos, hermanos, tíos, primos, sobrinos, cuñados)?',
            // help   : 'Escribe el valor de la respuesta',
            type   : 'number',
            body   : {
              value  : null,
